...
```
9년간 실무에서 데이터를 분석하고 프로세스를 설계해온 경험을 코드로 연결합니다.
...
![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-20232A?style=flat-square&logo=githubactions&logoColor=white)

**Tools**

![IntelliJ IDEA](https://img.shields.io/badge/IntelliJ_IDEA-20232A?style=flat-square&logo=intellijidea&logoColor=white)
![Git](https://img.shields.io/badge/Git-20232A?style=flat-square&logo=git&logoColor=white)
![Notion](https://img.shields.io/badge/Notion-20232A?style=flat-square&logo=notion&logoColor=white)
...
├── 팀 프로젝트 다수         — DayPoo(API · AI), 62댕냥(공공데이터)
└── 개인 프로젝트 다수       — Spring Migration, REACT(Design Archive)
```
