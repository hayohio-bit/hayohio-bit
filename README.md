...
<a href="https://github.com/hayohio-bit">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&pause=1000&color=7C3AED&center=true&width=650&lines=Hi%2C+I'm+HAYOUNG+%F0%9F%91%8B;Software+Engineer;Java+%C2%B7+Spring+%C2%B7+React;Bridging+Business+%26+Tech" alt="Typing SVG" />
</a>
...
├── Retail · BGF리테일 (7년)
│   ├── 데이터 자동화 — Excel VBA 시스템 5개+ 직접 설계·운영 (예산·경비·조직도·입찰·체크리스트)
│   ├── 프로세스 설계 — 금품수수 처리 체계 수립, 입찰 크롤링·모니터링 파이프라인 구축
│   ├── B2B 사업 지원 — 기업 고객 대상 상품 홍보물 기획·디자인 발주 관리
│   └── 전사 협업 — 협력업체 현황 취합·다부서 조율, 계열사 공문 발송 총괄
└── Insurance · 삼성화재 (2년)
